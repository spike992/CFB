...
NDefines.NAir.COMBAT_DAMAGE_SCALE_CARRIER = 18					-- same as above but used inside naval combat for carrier battles
...
NDefines.NIndustrialOrganisation.FUNDS_FOR_SIZE_UP_LEVEL_FACTOR = 80 -- How much each level mutliplies the funds for size up (Vanlla 0.8)
